...
#define Nu 398600.4   //the gravitational parameter of Earth, 398600.4 km3∕s2
#define i 63.4       //orbital inclination, deg 
#define R 6378.0

int main() {
    float Vc;                 //velocity of a satellite on a circular orbit, km∕s
    float Vi;                //velocity Vi ofthe end-point ofthe geocentric radius-vector, rotating with the Earth, km∕s
    float Va1;              //orbital velocity in the apogee, km∕s
    float Va2;
    float Va3;
    float We = 7.2921159;  //the angular speed of Earth’s rotation, 7.2921159 × 10−5
